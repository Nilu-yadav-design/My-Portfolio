          ...
          <div className="space-y-12">
            {experiences.map((exp, index) => (
              ...
              >
                ...
                {/* Content card */}
                <div className={`w-full md:w-5/12 ml-[56px] md:ml-0 ${index % 2 === 0 ? 'md:mr-auto md:pr-8' : 'md:ml-auto md:pl-8'
                  }`}>
                  <div className="glass-card rounded-3xl lg:p-6 p-3 card-hover">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className={`px-3 py-1 rounded-full bg-gradient-to-r ${exp.color} whitespace-nowrap text-white lg:text-sm text-[12px] font-medium`}>
                        {exp.period}
                      </div>
                    </div>
                    ...
                    <p className="text-muted-foreground mb-4 leading-relaxed lg:text-[16px] text-[14px]">
                      {exp.description}
                    </p>
